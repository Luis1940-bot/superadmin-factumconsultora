  ...
  final public static function loadClass(string $class): void
  {
    ...
    if (strpos($class, '_PHPStan_') === 0) {
      ...
      if (self::$composerAutoloader === null) {
        self::$composerAutoloader = require 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/autoload.php';
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/jetbrains/phpstorm-stubs/PhpStormStubsMap.php';
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/react/async/src/functions_include.php';
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/react/promise/src/functions_include.php';
      }
    ...
    if (!self::$polyfillsLoaded) {
      ...
      if (
        ...
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/symfony/polyfill-php80/Php80.php';
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/symfony/polyfill-php80/bootstrap.php';
      }
      ...
      if (
        ...
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/symfony/polyfill-intl-normalizer/Normalizer.php';
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/symfony/polyfill-intl-normalizer/bootstrap.php';
      }
      ...
      if (
        ...
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/symfony/polyfill-intl-grapheme/Grapheme.php';
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/symfony/polyfill-intl-grapheme/bootstrap.php';
      }
      ...
      if (
        ...
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/symfony/polyfill-php81/Php81.php';
        require_once 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/symfony/polyfill-php81/bootstrap.php';
      }
    }
    ...
    if (strpos($class, 'PHPStan\\BetterReflection\\') === 0) {
      ...
      $filepath = 'phar://' . __DIR__ . '/private/phpstan.phar/vendor/ondrejmirtes/better-reflection/src/' . $filename . '.php';
    } else {
      $filename = substr($filename, strlen('PHPStan\\'));
      $filepath = 'phar://' . __DIR__ . '/private/phpstan.phar/src/' . $filename . '.php';
    }
